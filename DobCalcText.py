...
# GUI elements
stepper_out_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 50), (200, 30)), text="Stepper GT2 Tooth Count", manager=manager)
stepper_out_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 50), (100, 30)), manager=manager)
stepper_out_input.set_text("20")

stage1_in_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 90), (200, 30)), text="Stage 1 GT2 Tooth Count (In)", manager=manager)
stage1_in_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 90), (100, 30)), manager=manager)
stage1_in_input.set_text("180")
stage1_out_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 130), (200, 30)), text="Stage 1 GT2 Tooth Count (Out)", manager=manager)
stage1_out_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 130), (100, 30)), manager=manager)
stage1_out_input.set_text("40")

stage2_in_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 170), (200, 30)), text="Stage 2 GT2 Tooth Count (In)", manager=manager)
stage2_in_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 170), (100, 30)), manager=manager)
stage2_in_input.set_text("180")
stage2_out_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 210), (200, 30)), text="Stage 2 GT2 Tooth Count (Out)", manager=manager)
stage2_out_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 210), (100, 30)), manager=manager)
stage2_out_input.set_text("40")

stage3_in_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 250), (200, 30)), text="Stage 3 GT2 Tooth Count (In)", manager=manager)
stage3_in_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 250), (100, 30)), manager=manager)
stage3_in_input.set_text("180")
stage3_out_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 290), (200, 30)), text="Stage 3 GT2 Tooth Count (Out)", manager=manager)
stage3_out_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 290), (100, 30)), manager=manager)
stage3_out_input.set_text("40")

telescope_in_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 330), (200, 30)), text="Telescope GT2 Tooth Count (In)", manager=manager)
telescope_in_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 330), (100, 30)), manager=manager)
telescope_in_input.set_text("240")

microstep_count_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 370), (200, 30)), text="Microstep Count", manager=manager)
microstep_count_dropdown = pygame_gui.elements.UIDropDownMenu(
    options_list=['0', '2', '4', '8', '16', '32', '64', '128', '256'],
    starting_option='0',
    relative_rect=pygame.Rect((220, 370), (100, 30)),
    manager=manager
)

stepper_step_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 410), (200, 30)), text="Stepper Steps per Revolution", manager=manager)
stepper_step_dropdown = pygame_gui.elements.UIDropDownMenu(
    options_list=['200', '400'],
    starting_option='200',
    relative_rect=pygame.Rect((220, 410), (100, 30)),
    manager=manager
)

speed_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((10, 450), (200, 30)), text="Speed (degrees per frame)", manager=manager)
speed_input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((220, 450), (100, 30)), manager=manager)
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.mod & pygame.KMOD_SHIFT:
                manager.focus_element.previous_focus()
            else:
                manager.focus_element.next_focus()
    ...
    try:
        ...
        microstep_count = int(microstep_count_dropdown.selected_option[0])
        stepper_step = int(stepper_step_dropdown.selected_option[0])
        stepper_speed = max(1, min(20, int(speed_input.get_text())))
    except ValueError:
        pass
    ...
    stepper_steps += stepper_speed / 360 * stepper_step
    ...
    for i in range(1, len(pulley_angles)):
        pulley_angles[i] += stepper_speed / cumulative_ratios[i - 1]
        pulley_rotations[i] += stepper_speed / 360 / cumulative_ratios[i - 1]
